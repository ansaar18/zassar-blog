...
x = '8BYkEfBA6O6donzWlSihBXox7C0sKR6b'
...
class BlogPost(db.Model):
    ...
    # Child Relationship 1 to User
    # Create Foreign Key, "users.id" the users refers to the tablename of User.
    # Create reference to the User object, the "posts" refers to the posts property in the User class.
    author_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    author = relationship("User", back_populates="posts")

    # Parent Relationship 3 to Comment
    # This will act like a List of Comment objects attached to each BlogPost.
    # The "parent_blog" refers to the parent_blog property in the BlogPost class.
...
class User(db.Model, UserMixin):
    ...
    # Parent Relationship 1 to BlogPost
    # This will act like a List of BlogPost objects attached to each User.
    # The "author" refers to the author property in the BlogPost class.
    posts = relationship("BlogPost", back_populates="author")

    # Parent Relationship 2 to Comment
...
class Comment(db.Model):
    ...
    # Child Relationship 2 to User
    # "users.id" The users refers to the tablename of the Users class.
    # "comments" refers to the comments property in the User class.
    author_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    comment_author = relationship("User", back_populates="comments")

    # Child Relationship 3 to BlogPost
    # "blog_posts.id" The users refers to the tablename of the BlogPost class.
    # "comments" refers to the comments property in the BlogPosts class.
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user is None:
            ...
            flash(message="Email is already registered. Log in instead!")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Gets user based on email entered
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            flash(message="Login to Comment")
            return redirect(url_for('login'))
        else:
            new_comment = Comment(
